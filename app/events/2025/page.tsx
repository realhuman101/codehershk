...
// If you want to add any special components, import here, e.g.
// import WorkshopsSection from "@/app/components/WorkshopsSection";
    ...
    <main className="flex flex-col px-6 md:px-16 lg:px-24 2xl:px-64 xl:px-48">
      ...
      <div className="flex flex-col-reverse pt-4 pb-10 lg:gap-8 gap-y-12 md:py-16 md:flex-row mb-10">
        ...
        <div className="flex-grow">
          {/* You could place an image here if you want a hero illustration */}
        </div>
      </div>
